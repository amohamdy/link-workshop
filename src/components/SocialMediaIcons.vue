<template>
    <ul class="social-media" :class="{'footer' : isFooter}">
        <li class="nav-item">
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="19.696" height="24.241" viewBox="0 0 19.696 24.241"><g><path d="M24.241,2.332a10.361,10.361,0,0,1-2.864.785A4.942,4.942,0,0,0,23.564.37a9.932,9.932,0,0,1-3.151,1.2,4.969,4.969,0,0,0-8.6,3.4A5.117,5.117,0,0,0,11.931,6.1,14.067,14.067,0,0,1,1.688.906,4.971,4.971,0,0,0,3.215,7.548,4.908,4.908,0,0,1,.97,6.936v.055a4.993,4.993,0,0,0,3.982,4.883,4.96,4.96,0,0,1-1.3.164,4.394,4.394,0,0,1-.941-.085,5.017,5.017,0,0,0,4.644,3.462,9.986,9.986,0,0,1-6.162,2.12A9.309,9.309,0,0,1,0,17.466,13.991,13.991,0,0,0,7.624,19.7,14.047,14.047,0,0,0,21.769,5.554c0-.22-.008-.432-.018-.642A9.914,9.914,0,0,0,24.241,2.332Z" fill="#fff"/></g></svg>  </a></li>
        <li class="nav-item">
            <a href="">
